...
In regard to the data mining goals, the knowledge that there exists periods of 
...
business success criteria was also not at its most potential however these
...
Earth's seasons. In order to investigate this an additional assumption had to be
made. This assumption was that the Earth's seasons changed around the time of
...
numbers aligns or does not align with that of the Earth's seasons.
...
created by filtering the enrolements from the larger enrolments data frame to
...
Mandarin and Hindi in order to accommodate for the large number of students from
...
different for other courses, and also the length of time over which data was 
collected may not be long enough to accurately predict trends. To combat this
